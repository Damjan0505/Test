...
#Download and install Sublime
wget -qO - https://download.sublimetext.com/sublimehq-pub.gpg | sudo apt-y add -
echo "deb https://download.sublimetext.com/ apt/stable/" | sudo tee /etc/apt/sources.list.d/sublime-text.list^C
